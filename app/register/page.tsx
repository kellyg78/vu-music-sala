...
export default function RegisterPage() {
  ...
  return (
    <main className="min-h-screen grid-background relative overflow-hidden flex items-center justify-center py-12">
      {/* Background */}
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <div className="bg-vaporwave-purple/20 backdrop-blur-lg rounded-2xl p-8 border-2 border-neon-purple/50 neon-border">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-gray-400 font-retro text-sm text-center">
              Join VU Music Sala today!
            </p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div>
              <label htmlFor="username" className="block text-sm font-retro text-neon-pink mb-2">
                Username*
              </label>
              <input
                id="username"
            ...
            <div className="text-center">
              ...
              <Link href="/login" className="text-neon-cyan hover:text-neon-pink transition-colors font-retro text-sm font-bold">
                Log In
              </Link>
            </div>
          </form>
